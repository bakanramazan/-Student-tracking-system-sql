...
{
    public partial class BOLUM_SILME_ISLEMI : Form
    {
        public BOLUM_SILME_ISLEMI()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            bag.Open();
            string listele = "select * from BOLUMLER";
       ...
       public void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            komut.CommandText = " DELETE FROM BOLUMLER WHERE BOLUM_KODU=" + dataGridView1.CurrentRow.Cells[0].Value.ToString() + "";
